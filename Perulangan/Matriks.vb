Public Class Matriks
    ...
    Private Property Txb_matrik1 As Object

    Private Property Txb_matrik2 As Object
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            Hitung(copyMatriks1, copyMatriks2, barisMatriks1, kolomMatriks2)
    ...
    Private Sub Hitung(ByVal matriks1(,) As Integer, matriks2(,) As Integer, batasBaris As Integer, batasKolom As Integer)
        Dim hasil As String = ""
        If (Me.cekKolom) Then
            Select Case Me.Text
                Case "Tambah"
